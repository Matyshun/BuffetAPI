...
CREATE TABLE STORE_SCHEDULE(
    ...
    start_lunch_hour    VARCHAR(32)             NOT NULL,
    end_lunch_hour      VARCHAR(32)             NOT NULL,
...
to_date('01-06-2020 09:00 AM','DD-MM-YYYY HH:MI AM'),--start_date_hour
to_date('01-06-2020 09:30 AM','DD-MM-YYYY HH:MI AM'),--end_date_hour
...
'70BA44E0EC9A42018FA0D9465CC695B5',--appuser_id
to_date('01-06-2020 10:00 AM','DD-MM-YYYY HH:MI AM'),--start_date_hour
to_date('01-06-2020 12:00 AM','DD-MM-YYYY HH:MI AM'),--end_date_hour
'ACT',--status_reserve_id
to_date('01-06-2020 09:00 AM','DD-MM-YYYY HH:MI AM'),--updated_at
to_date('01-06-2020 09:00 AM','DD-MM-YYYY HH:MI AM'),--created_at
0--deleted
...
'70BA44E0EC9A42018FA0D9465CC695B5',--appuser_id
to_date('01-06-2020 02:00 PM','DD-MM-YYYY HH:MI PM'),--start_date_hour
to_date('01-06-2020 02:30 PM','DD-MM-YYYY HH:MI PM'),--end_date_hour
'ACT',--status_reserve_id
to_date('01-06-2020 09:00 AM','DD-MM-YYYY HH:MI AM'),--updated_at
to_date('01-06-2020 09:00 AM','DD-MM-YYYY HH:MI AM'),--created_at
0--deleted
...
to_date('02-06-2020 05:00 PM','DD-MM-YYYY HH:MI PM'),--start_date_hour
to_date('02-06-2020 05:00 PM','DD-MM-YYYY HH:MI PM'),--end_date_hour
...
'44703D2E22344158BAE3E3BB30699F06',--serv_id
to_date('01-06-2020 05:00 PM','DD-MM-YYYY HH:MI PM'),--start_date_hour
to_date('01-06-2020 07:00 PM','DD-MM-YYYY HH:MI PM'),--end_date_hour
to_date('01-06-2020 09:00 AM','DD-MM-YYYY HH:MI AM'),--updated_at
to_date('01-06-2020 09:00 AM','DD-MM-YYYY HH:MI AM'),--created_at
0--deleted
);
...
sys_guid(),
to_date('01-06-2020 09:00 AM','DD-MM-YYYY HH:MI AM'),--start_hour
to_date('01-06-2020 01:00 PM','DD-MM-YYYY HH:MI PM'),--start_lunch_hour
to_date('01-06-2020 02:00 PM','DD-MM-YYYY HH:MI PM'),--end_lunch_hour
to_date('01-06-2020 07:00 PM','DD-MM-YYYY HH:MI PM'),--end_hour
to_date('01-06-2020 09:00 AM','DD-MM-YYYY HH:MI AM'),--updated_at
to_date('01-06-2020 09:00 AM','DD-MM-YYYY HH:MI AM'),--created_at
0--deleted
);
